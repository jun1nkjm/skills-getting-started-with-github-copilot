...
activities = {
    ...
    "Volleyball Club": {
        "description": "Team volleyball training and matches",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:00 PM",
        "max_participants": 14,
        "participants": ["jessica@mergington.edu", "amanda@mergington.edu"]
    },
    "Art Studio": {
    ...
    "Drama Club": {
        "description": "Theater performances and acting training",
    ...
    "Math club": {
        ...
        "max_participants": 16,
        "participants": ["david@mergington.edu", "ryan@mergington.edu"]
    },
    "Robotics Club": {
